...
- посмотреть проект, потыкать кнопочки, почитать про атомарку, про материал, про сторибук
- компонент Loader 1 час ( тестовый вариант )
- компонент RequestStatus 1 час
- компонент SelectField 1 час
- компонент TextareaField 1 час
- компонент CheckboxWithText 1 час
- компонент DeliveryTime 1 час
- страница 2 (story с моковыми данными) 1 час
- страница 3 (story с моковыми данными) 1 час
